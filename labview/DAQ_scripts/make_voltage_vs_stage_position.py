...
##############################################
output_file = r"C:\Data\20160320\bead1\chameleon_force_20160320_beta1e5_linear.txt"
cant_pos_at_10V = 150. ##20. ## um
beta = 1e5 ## pick a reasonable beta to give observable force at 1V
##############################################
...
bias_for_fit = 10.0 #volts
Afit = 1.1e-12 ##8.9e-11  #coefficients for DC bias at 10V
def ffn(x):
    return Afit*(1./(x+150.))**1 ##2
...
elec_dcvolt_vs_volt = force_ratio ##np.sqrt(force_ratio)
