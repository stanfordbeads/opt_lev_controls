...
class Ui_catcherDropperUI(object):
    def setupUi(self, catcherDropperUI):
        ...
        self.Catcher.setGeometry(QtCore.QRect(130, 110, 100, 16)) # (xstart, ystart, xwidth, ywidth)
        font = QtGui.QFont()
...
"color: rgb(0, 0, 0);")
    ...
    def retranslateUi(self, catcherDropperUI):
        ...
        self.Catcher.setText("attractor")
    ...
    def connectAGL(self):
        ...
        self.agl = ik.newport.AGUC2.open_serial(port=com_port, baud=921600)
        # sleep(3)
